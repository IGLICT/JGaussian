...
def conv2d(input, weight, bias=None, stride=1, padding=0, dilation=1, groups=1):
    ...
    return nn.conv2d(x=input, weight=weight, bias=bias, stride=stride, padding=padding, dilation=dilation, groups=groups)

def conv_transpose2d(input, weight, bias=None, stride=1, padding=0, output_padding=0, groups=1, dilation=1):
    # if _should_use_custom_op(input):
    #     return _conv2d_gradfix(transpose=True, weight_shape=weight.shape, stride=stride, padding=padding, output_padding=output_padding, groups=groups, dilation=dilation).apply(input, weight, bias)
    return nn.conv_transpose2d(input=input, weight=weight, bias=bias, stride=stride, padding=padding, output_padding=output_padding, groups=groups, dilation=dilation)

#----------------------------------------------------------------------------

def _should_use_custom_op(input):
    assert isinstance(input, jt.array)
...
#     # Forward & backward.
#     class Conv2d(jt.Function):
        
#         @staticmethod
#         def execute(self, input, weight, bias):
...
#             # General case => cuDNN.
#             if transpose:
#                 return nn.conv_transpose2d(input=input, weight=weight, bias=bias, output_padding=output_padding, **common_kwargs)
#             return nn.conv2d(input=input, weight=weight, bias=bias, **common_kwargs)
